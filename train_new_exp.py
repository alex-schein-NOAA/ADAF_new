...
from utils.dataloader_multifiles_exp import get_data_loader
...
class Trainer:
    ...
    def loss_function(self,
        ...
        pre_field_obs_masked = torch.masked_fill(input=pre_field.clone(), mask=~obs_tar_mask, value=0
